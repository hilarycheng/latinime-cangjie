...
import static com.diycircuits.inputmethod.latin.Constants.ImeOption.FORCE_ASCII;
import static com.diycircuits.inputmethod.latin.Constants.ImeOption.NO_MICROPHONE;
import static com.diycircuits.inputmethod.latin.Constants.ImeOption.NO_MICROPHONE_COMPAT;
...
import com.diycircuits.inputmethod.accessibility.AccessibilityUtils;
import com.diycircuits.inputmethod.accessibility.AccessibleKeyboardViewProxy;
import com.diycircuits.inputmethod.compat.CompatUtils;
import com.diycircuits.inputmethod.compat.InputMethodManagerCompatWrapper;
import com.diycircuits.inputmethod.compat.InputMethodServiceCompatUtils;
import com.diycircuits.inputmethod.compat.SuggestionSpanUtils;
import com.diycircuits.inputmethod.keyboard.KeyDetector;
import com.diycircuits.inputmethod.keyboard.Keyboard;
import com.diycircuits.inputmethod.keyboard.KeyboardActionListener;
import com.diycircuits.inputmethod.keyboard.KeyboardId;
import com.diycircuits.inputmethod.keyboard.KeyboardSwitcher;
import com.diycircuits.inputmethod.keyboard.KeyboardView;
import com.diycircuits.inputmethod.keyboard.MainKeyboardView;
import com.diycircuits.inputmethod.latin.LocaleUtils.RunInLocale;
import com.diycircuits.inputmethod.latin.Utils.Stats;
...
public final class LatinIME extends InputMethodService implements KeyboardActionListener,
    ...
    public void onCodeInput(final int primaryCode, final int x, final int y) {
		...
		if (mKeyboardSwitcher.getMainKeyboardView() != null &&
		    ...
		    isCangjieMode() && primaryCode != 12290 && primaryCode != 65292) {
		    if (!mCangjie.isFull()) {
			boolean result = true;
			if (mCangjie != null) {
			    final MainKeyboardView mainKeyboardView = mKeyboardSwitcher.getMainKeyboardView();
