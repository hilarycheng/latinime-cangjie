...
import com.diycircuits.inputmethod.keyboard.PointerTracker.DrawingProxy;
...
import com.diycircuits.inputmethod.keyboard.internal.SuddenJumpingTouchEventHandler;
import com.diycircuits.inputmethod.latin.Constants;
...
import com.diycircuits.inputmethod.latin.Utils.UsabilityStudyLogUtils;
...
public final class MainKeyboardView extends KeyboardView implements PointerTracker.KeyEventHandler,
	...
	return PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean("swipe_cursor_movement_enable", false);
    }
    
    private int getSwipeStep() {
	return PreferenceManager.getDefaultSharedPreferences(getContext()).getInt("swipe_cursor_movement", 30);
    }
